...
//  final User user;
  ...
  Order(this.id, this.provider_id, this.service_id, this.category_id,
      ...
      this.provider_first_name, this.provider_image, this.provider_last_name, this.rating, this.comment,
      this.user_id,this.address, this.otp);
  //this.provider, this.user, this.ratings

  Order.fromJson(Map<String, dynamic> json)
      : id = json['id'], provider_id = json['provider_id'],
        service_id = json['service_id'], service = json['service'], category_id = json['category_id'], category = json['category'],
