                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(child: Padding(padding: EdgeInsets.only(left: 0.0),
                        ...
                        flex: 1,),
                      Expanded(child: Text(AppLocalizations.of(context).translate('ur_book')),
                        flex: 4,),
                      Expanded(child: Icon(Icons.arrow_right, color: Hexcolor('#FB6907'), size: 50,),
                        flex: 1,),
                    ],
                  ),
                  onTap: () => {
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(child: Padding(padding: EdgeInsets.only(left: 0.0),
                      ...
                      flex: 1,),
                    Expanded(child: Text(AppLocalizations.of(context).translate('cus_book')),
                      flex: 4,),
                    Expanded(child: Icon(Icons.arrow_right, color: Hexcolor('#FB6907'), size: 50,),
                      flex: 1,),
                  ],
